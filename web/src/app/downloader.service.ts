...
export class DownloaderService {
  ...
  private readonly TRIGGER_DOWNLOAD_FETCH_URL = '/api/trigger-fetch-download';
  ...
  triggerFetchDownload(): Observable<IDownloading|ErrorMessage> {
    return this.http.get<IDownloading>(this.TRIGGER_DOWNLOAD_FETCH_URL)
    .pipe(
      catchError(
        this.parseFuncs.parseHttpError
      )
